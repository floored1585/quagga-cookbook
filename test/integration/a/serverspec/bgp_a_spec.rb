...
describe file("#{cfg_dir}/bgpd.conf") do
  ...
  # 'soft-reconfiguration inbound' should appear twice
  its(:content) { should contain("neighbor swp1 soft-reconfiguration inbound").after(/neighbor swp1 (peer-group$|remote-as|interface)/).before('address-family ipv6') }
  ...
  its(:content) { should contain("neighbor swp1 next-hop-self").after(/neighbor swp1 (peer-group$|remote-as|interface)/).before('address-family ipv6') }
  ...
  its(:content) { should contain("neighbor hosts_v6 prefix-list TEST_IN_V6 in").after(/neighbor hosts_v6 peer-group\s*$/) }
  its(:content) { should contain("neighbor hosts_v6 prefix-list TEST_OUT_V6 out").after(/neighbor hosts_v6 peer-group\s*$/) }
  its(:content) { should contain("bgp listen range 2600::/64 peer-group hosts_v6").after(/neighbor hosts_v6 peer-group\s*$/) }
  its(:content) { should contain("bgp listen range 1000:1::/64 peer-group hosts_v6").after(/neighbor hosts_v6 peer-group\s*$/) }

  # 'neighbor 2001:db8::abcd peer-group hosts_v6' should appear TWICE
  ...
  its(:content) { should contain("neighbor 2001:db8::abcd peer-group hosts_v6").after('hosts_v6 peer-group').after('address-family ipv6') }
  ...
  its(:content) { should contain("neighbor 2001:db8::abcd activate").after('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::abcd capability orf prefix-list both").before('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::abcd capability orf prefix-list both").after('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::abcd capability extended-nexthop").before('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::abcd capability extended-nexthop").after('address-family ipv6') }
  ...
  its(:content) { should_not contain("neighbor 2001:db8::dead soft-reconfiguration inbound").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead capability orf prefix-list both").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead capability orf prefix-list both").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead prefix-list TEST_IN_V6 in").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead prefix-list TEST_IN_V6 in").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead prefix-list TEST_OUT_V6 out").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead prefix-list TEST_OUT_V6 out").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead route-map TEST_IN_V6 in").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead route-map TEST_IN_V6 in").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead route-map TEST_OUT_V6 out").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead route-map TEST_OUT_V6 out").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead route-map TEST_IMPORT_V6 import").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead route-map TEST_IMPORT_V6 import").before('address-family ipv6') }
  its(:content) { should contain("neighbor 2001:db8::dead route-map TEST_EXPORT_V6 export").after('address-family ipv6') }
  its(:content) { should_not contain("neighbor 2001:db8::dead route-map TEST_EXPORT_V6 export").before('address-family ipv6') }
