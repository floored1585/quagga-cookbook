...
node.set['quagga']['bgp']['64512']['neighbors']['swp1']['next_hop_self'] = true
...
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::abcd']['ipv6'] = true
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::abcd']['capability'] = ['orf prefix-list both', 'extended-nexthop'] # Should appear v4 only
...
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['capability'] = 'orf prefix-list both' # should appear v6 only
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['soft_reconfig_in'] = true
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['prefix_list_in'] = 'TEST_IN_V6'
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['prefix_list_out'] = 'TEST_OUT_V6'
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['route_map_in'] = 'TEST_IN_V6'
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['route_map_out'] = 'TEST_OUT_V6'
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['route_map_import'] = 'TEST_IMPORT_V6'
node.set['quagga']['bgp']['64512']['neighbors']['2001:db8::dead']['ipv6']['route_map_export'] = 'TEST_EXPORT_V6'
